  ...
  exports.runAnnotationTest = async() => {
    ...
    const main = async() => {
      try {
        ...
        await doc.save('../../TestFiles/Output/annotation_test1.pdf', PDFNet.SDFDoc.SaveOptions.e_linearized);
        ...
        await doc.save('../../TestFiles/Output/annotation_test2.pdf', PDFNet.SDFDoc.SaveOptions.e_linearized);
        ...
        await docnew.save('../../TestFiles/Output/new_annot_test_api.pdf', PDFNet.SDFDoc.SaveOptions.e_linearized);
