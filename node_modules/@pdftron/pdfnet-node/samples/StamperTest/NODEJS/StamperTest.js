  ...
  exports.runStamperTest = () => {
    ...
    const main = async() => {
      ...
      try {
        ...
        await doc.save('../../TestFiles/Output/newsletter.ex1.pdf', PDFNet.SDFDoc.SaveOptions.e_linearized);
      ...
      try {
        ...
        const img = await PDFNet.Image.createFromFile(doc, inputURL + 'peppers.jpg');
        ...
        await doc.save('../../TestFiles/Output/newsletter.ex2.pdf', PDFNet.SDFDoc.SaveOptions.e_linearized);
        await PDFNet.endDeallocateStack();
      } catch (err) {
        console.log(err.stack);
        ret = 1;
      ...
      try {
        ...
        const doc = await PDFNet.PDFDoc.createFromFilePath(inputURL + 'newsletter.pdf');
        doc.initSecurityHandler();
        const fishDoc = await PDFNet.PDFDoc.createFromFilePath(inputURL + 'fish.pdf');
        ...
        await doc.save('../../TestFiles/Output/newsletter.ex3.pdf', PDFNet.SDFDoc.SaveOptions.e_linearized);
        await PDFNet.endDeallocateStack();
      } catch (err) {
        console.log(err.stack);
        ret = 1;
      ...
      try {
        ...
        await doc.save('../../TestFiles/Output/newsletter.ex4.pdf', PDFNet.SDFDoc.SaveOptions.e_linearized);
        await PDFNet.endDeallocateStack();
      } catch (err) {
        console.log(err.stack);
        ret = 1;
      ...
      try {
        ...
        await doc.save('../../TestFiles/Output/newsletter.ex5.pdf', PDFNet.SDFDoc.SaveOptions.e_linearized);
      ...
      try {
        ...
        await doc.save('../../TestFiles/Output/newsletter.ex6.pdf', PDFNet.SDFDoc.SaveOptions.e_linearized);
      ...
      try {
        ...
        await doc.save('../../TestFiles/Output/newsletter.ex7.pdf', PDFNet.SDFDoc.SaveOptions.e_linearized);
      ...
      try {
        ...
        await doc.save('../../TestFiles/Output/newsletter.ex8.pdf', PDFNet.SDFDoc.SaveOptions.e_linearized);
