  ...
  exports.runEncTest = () => {
    ...
    const main = async() => {
      ...
      try {
        ...
        let islocked = false;
        doc = await PDFNet.PDFDoc.createFromFilePath(inputUrl + 'fish.pdf');
        ...
        if (performOperation) {
          ...
          const embedFile = await PDFNet.Filter.createMappedFileFromUString(inputUrl + 'my_stream.txt');
        ...
        await doc.save('../../TestFiles/Output/secured.pdf', PDFNet.SDFDoc.SaveOptions.e_linearized);
      } catch (err) {
        console.log(err);
      ...
      try {
        ...
        await securedDoc.save('../../TestFiles/Output/not_secured.pdf', PDFNet.SDFDoc.SaveOptions.e_linearized);
        console.log('done');
      } catch (err) {
        console.log(err.stack);
        ret = 1;
