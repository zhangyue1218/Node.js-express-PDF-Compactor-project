  ...
  exports.runInteractiveFormsTest = () => {
    ...
    const main = async() => {
      ...
      try {
        ...
        await doc.save('../../TestFiles/Output/forms_test1.pdf', 0);
      ...
      try {
        ...
        await doc2.save('../../TestFiles/Output/forms_test_edit.pdf', 0);
      ...
      try {
        ...
        await doc3.save('../../TestFiles/Output/forms_test1_cloned.pdf', 0);
      ...
      try {
        ...
        await doc4.save('../../TestFiles/Output/forms_test1_flattened.pdf', 0);
