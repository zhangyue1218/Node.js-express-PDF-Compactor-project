...
((exports) => {
  ...
  exports.runPDFLayersTest = () => {
    ...
    const CreateGroup1 = async(doc, layer) => {
      ...
      const img = await PDFNet.Image.createFromFile(doc, '../../TestFiles/peppers.jpg', nullEncoderHints);
    ...
    const main = async() => {
      ...
      try {
        ...
        await doc.save('../../TestFiles/Output/pdf_layers.pdf', PDFNet.SDFDoc.SaveOptions.e_linearized);
      ...
      try {
        ...
        if (!(await doc.hasOC())) {
          ...
          await pdfdraw.export(page, '../../TestFiles/Output/pdf_layers_default.png');
          ...
          if (ocgs !== null) {
            ...
            for (i = 0; i < sz; ++i) {
              ...
              fname += '.png';
              await pdfdraw.export(page, '../../TestFiles/Output/' + fname);
            }
          }
          ...
          await pdfdraw.export(page, '../../TestFiles/Output/pdf_layers_non_oc.png');
        }
