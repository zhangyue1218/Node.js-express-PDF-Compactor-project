...
((exports) => {
  ...
  exports.runOptimizerTest = () => {
    const main = async () => {
      ...
      const input_filename = "newsletter";
      ...
      try {
        ...
        await PDFNet.Optimizer.optimize(doc, opt_settings);
        doc.save(output_path + input_filename + "_opt3.pdf", PDFNet.SDFDoc.SaveOptions.e_linearized);
      }
      catch (err) {
        console.log(err);
      }
      ...
      try {
        const doc = await PDFNet.PDFDoc.createFromFilePath(input_path + "TigerText.pdf");
        await doc.initSecurityHandler();
        ...
        doc.save(output_path + "TigerText_flatten.pdf", PDFNet.SDFDoc.SaveOptions.e_linearized);
      }
      catch (err) {
        console.log(err);
      }
